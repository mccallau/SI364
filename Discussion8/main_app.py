...
playlistsong = db.Table('playlistsong',db.Column('song_id',db.Integer, db.ForeignKey('songs.id')),db.Column('playlist_id',db.Integer, db.ForeignKey('playlists.id')))
playlistarist = db.Table('playlistartist',db.Column('artist_id',db.Integer, db.ForeignKey('artists.id')),db.Column('playlist_id',db.Integer, db.ForeignKey('playlists.id')))
...
class Playlists(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    name = db.Column(db.String(64))
    artists = db.relationship('Artist',secondary=playlistartist,backref=db.backref('playlists',lazy='dynamic'),lazy='dynamic')
    songs = db.relationship('Song',secondary=playlistsong,backref=db.backref('playlists',lazy='dynamic'),lazy='dynamic')
